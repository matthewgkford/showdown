  ...
  if (hasImage) {
    return (
      <Image
        ...
        width={CARD_WIDTH}
        height={CARD_HEIGHT}
        className="w-full h-auto rounded-lg shadow-md shadow-black/40"
...
function Placeholder({ card }: { card: CardType }) {
  return (
    <div
      className="flex flex-col items-center justify-center rounded-lg border border-dashed border-zinc-700 bg-zinc-900/40 p-6 text-center"
